    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">AI-powered 12-month revenue projections with scenario planning</p>
        </div>
        <div className="flex items-center gap-4">
          <ModelSelector
            ...
            isLoading={isLoading}
          />
          <ExportControls forecastData={forecastData} />
          <ExportControls forecastData={forecastData} selectedModel={selectedModel} />
        </div>
      </div>
